...
Gem::Specification.new do |s|
  ...
  s.test_files = [
    ...
    "spec/support/rails_app/test/functional/people_controller_test.rb",
    "spec/support/rails_app/test/unit/helpers/people_helper_test.rb",
    "spec/support/rails_app/test/unit/person_test.rb"
  ]
